...
//getter qui retourne l'attribut "m_aff_som_temp"
bool Sommet::getAffSomTemp()
{
    return m_aff_som_temp;
}
...
//setter qui modifie l'attribut "m_aff_som_temp"
void Sommet::setAffSomTemp(bool aff_temp)
{
    m_aff_som_temp=aff_temp;
}
